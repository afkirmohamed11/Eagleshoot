export const translations = { 
  en: { 
    ...
    'about.story.content': 'Eagle Shoot Photography was born from a deep passion for nature and the art of storytelling through imagery. What began as capturing stunning landscapes has evolved into a renowned brand synonymous with excellence across all photography disciplines. Our professional team, with eagle-eyed precision, combines vast experience and creative talent to ensure every shot is a work of art. We specialize in landscapes, portraits, weddings, events, and commercial photography, transforming fleeting moments into timeless images. Eagle Shoot Photography is not just a service—it’s an artistic journey. We aim to encapsulate your precious moments into images that you will cherish for a lifetime.',  
...
'portfolio.categories.nature': 'Nature',
...
'about.story.content': 'Eagle Shoot Photography est né d\’une profonde passion pour la nature et l\’art de raconter des histoires à travers des images. Ce qui a commencé par la capture de paysages époustouflants a évolué pour devenir une marque renommée, synonyme d\’excellence dans toutes les disciplines de la photographie. Notre équipe professionnelle, dotée d\’une précision d\’aigle, allie une vaste expérience et un talent créatif pour faire de chaque cliché une œuvre d\’art.',
    'about.story.specialization':'Nous sommes spécialisés dans les paysages, les portraits, les mariages, les événements et la photographie commerciale, transformant des instants éphémères en images intemporelles. Eagle Shoot Photography n\’est pas seulement un service, c\’est un voyage artistique. Nous avons pour objectif d\’immortaliser vos moments précieux dans des images que vous chérirez toute votre vie.',    'about.equipment.title': 'Équipement Professionnel', 
...
'portfolio.showLess': 'Afficher moins',
  ...
  ar: { 
    ...
    'about.story.content': 'ولدت إيغل شوت للتصوير الفوتوغرافي من شغف عميق بالطبيعة وفن رواية القصص من خلال الصور. ما بدأ بتسجيل مناظر طبيعية خلابة تطور ليصبح علامة تجارية مشهورة مرادفة للتميز في جميع مجالات التصوير الفوتوغرافي. فريقنا المحترف، بدقة تشبه عين الصقر، يجمع بين الخبرة الواسعة والموهبة ',
    ...
    'portfolio.categories.portrait': 'صور شخصية',    'portfolio.categories.event': 'مناسبات',
    'portfolio.categories.commercial': 'تجاري',
    'portfolio.categories.nature': 'طبيعة',
